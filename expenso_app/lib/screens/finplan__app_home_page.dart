...
class _FinPlanAppHomePageState extends State<FinPlanAppHomePage> {
  ...
  getTokenFilecontent() async{
    ...
    final accessToken = await SalesforceAuthService.getFromFile(key : 'access_token');
            ...
            availableActions: [
              {
                Icons.logout : ({input = ''}) async{
                  ...
                  Navigator.pushReplacement(
                    context, 
                    MaterialPageRoute(
                      builder: (context)=> Scaffold(appBar: AppBar(), body: FinPlanSplashPage())
                    )
                  );
                  return true;
                },
